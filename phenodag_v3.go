...
var v3PortRepos = []string{
	...
	"helioscope", "PhenoProc", "PhenoKits", "localbase3", "phenoRuntime",
...
var v3PortL8 = []v3PortTask{
	...
	{ID: "task-08-13", Stage: 8, Subproject: "PhenoKits", Category: "sota", Kind: "sota", Priority: 9, Status: "ready", Description: "SOTA code-generation kit: parsing, linting, scaffolding with AI-on-failure."},
...
var v3PortL9 = []v3PortTask{
	...
	{ID: "task-09-13", Stage: 9, Subproject: "PhenoKits", Category: "deploy", Kind: "release", Priority: 8, Status: "ready", Description: "NPM/PyPI/Crates publish via OIDC; provenance attestations; staged rollout via registry API."},
...
var v3PortL10 = []v3PortTask{
	...
	{ID: "task-10-13", Stage: 10, Subproject: "PhenoKits", Category: "sustain", Kind: "governance", Priority: 7, Status: "ready", Description: "Template deprecation: auto-detect unused templates; archive with 30-day notice; sunset."},
